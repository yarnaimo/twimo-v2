...
export type GenericTweetsTimelineResponse = unknown
...
export interface UsersFollowersLookupResponse {
  ...
  /**
   *
   * @type {UsersFollowersLookupResponseMeta}
   * @memberof UsersFollowersLookupResponse
   */
  meta?: UsersFollowersLookupResponseMeta
}
/**
 *
 * @export
 * @interface UsersFollowersLookupResponseMeta
 */
export interface UsersFollowersLookupResponseMeta {
  /**
   * The previous token
   * @type {string}
   * @memberof UsersFollowersLookupResponseMeta
   */
  previous_token?: string
  /**
   * The next token
...
/**
 * MentionsApi - axios parameter creator
 * @export
 */
export const MentionsApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
     ...
     * @param {string} [startTime] YYYY-MM-DDTHH:mm:ssZ. The earliest UTC timestamp from which the mentions will be provided. The since_id parameter takes precedence if it is also specified.
...
/**
 * MentionsApi - functional programming interface
 * @export
 */
export const MentionsApiFp = function (configuration?: Configuration) {
  return {
    /**
     * Returns Tweet objects that mention username associated to the provided User ID
     * @summary Returns Tweet objects that mention the username associated to the provided User ID
    ...
    > {
      const localVarAxiosArgs = await MentionsApiAxiosParamCreator(
        configuration,
      ).usersIdMentions(
        id,
        sinceId,
...
/**
 * MentionsApi - factory interface
 * @export
 */
export const MentionsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  return {
    ...
    usersIdMentions(
      ...
      return MentionsApiFp(configuration)
        .usersIdMentions(
          id,
          sinceId,
          untilId,
...
/**
 * Request parameters for usersIdMentions operation in MentionsApi.
 * @export
 * @interface MentionsApiUsersIdMentionsRequest
 */
export interface MentionsApiUsersIdMentionsRequest {
  /**
   * The ID of the User to list mentions of
   * @type {string}
   * @memberof MentionsApiUsersIdMentions
   */
  readonly id: string
...
/**
 * MentionsApi - object-oriented interface
 * @export
 * @class MentionsApi
 * @extends {BaseAPI}
 */
export class MentionsApi extends BaseAPI {
  /**
   * Returns Tweet objects that mention username associated to the provided User ID
   * @summary Returns Tweet objects that mention the username associated to the provided User ID
   * @param {MentionsApiUsersIdMentionsRequest} requestParameters Request parameters.
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   * @memberof MentionsApi
   */
  public usersIdMentions(
    requestParameters: MentionsApiUsersIdMentionsRequest,
    options?: any,
  ) {
    return MentionsApiFp(this.configuration)
      .usersIdMentions(
...
export const UsersApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @summary Returns user objects that are being followed by the provided user ID
     * @param {string} id The ID of the user for whom to return results
     * @param {number} [maxResults] The maximum number of results
     * @param {string} [paginationToken] This value is populated by passing the \&#39;next_token\&#39; or \&#39;previous_token\&#39; returned in a request to paginate through results.
     * @param {*} [options] Override http request option.
  ...
  return {
    ...
    async usersIdFollowers(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<UsersFollowersLookupResponse>
    > {
      const localVarAxiosArgs = await UsersApiAxiosParamCreator(
        configuration,
