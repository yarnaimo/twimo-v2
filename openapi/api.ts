 ...
 * @export
 */
export const CountsApiAxiosParamCreator = function (
...
export const CountsApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs = await CountsApiAxiosParamCreator(
        configuration,
 ...
 * @export
 */
export const CountsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  return {
    ...
    tweetCountsFullArchiveSearch(
      ...
      return CountsApiFp(configuration)
        .tweetCountsFullArchiveSearch(
          query,
          startTime,
          endTime,
...
/**
 * Request parameters for tweetCountsFullArchiveSearch operation in CountsApi.
 * @export
 * @interface CountsApiTweetCountsFullArchiveSearchRequest
 */
export interface CountsApiTweetCountsFullArchiveSearchRequest {
  /**
   * One query/rule/filter for matching Tweets. Up to 2048 characters.
   * @type {string}
   * @memberof CountsApiTweetCountsFullArchiveSearch
   */
...
/**
 * Request parameters for tweetCountsRecentSearch operation in CountsApi.
 * @export
 * @interface CountsApiTweetCountsRecentSearchRequest
 */
export interface CountsApiTweetCountsRecentSearchRequest {
  /**
   * One query/rule/filter for matching Tweets. Up to 2048 characters.
   * @type {string}
   * @memberof CountsApiTweetCountsRecentSearch
   */
  readonly query: string
...
export class CountsApi extends BaseAPI {
   ...
   * Returns Tweet Counts that match a search query.
   * @summary Full archive search counts
   * @param {CountsApiTweetCountsFullArchiveSearchRequest} requestParameters Request parameters.
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   * @memberof CountsApi
   */
  public tweetCountsFullArchiveSearch(
    requestParameters: CountsApiTweetCountsFullArchiveSearchRequest,
    options?: any,
  ) {
    return CountsApiFp(this.configuration)
      .tweetCountsFullArchiveSearch(
   ...
   * Returns Tweet Counts from the last 7 days that match a search query.
   * @summary Recent search counts
   * @param {CountsApiTweetCountsRecentSearchRequest} requestParameters Request parameters.
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   * @memberof CountsApi
   */
  public tweetCountsRecentSearch(
    requestParameters: CountsApiTweetCountsRecentSearchRequest,
    options?: any,
  ) {
    return CountsApiFp(this.configuration)
      .tweetCountsRecentSearch(
  ...
  return {
    ...
    async tweetsIdLikingUsers(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<TweetsLikingUsersLookupResponse>
    > {
      const localVarAxiosArgs = await UsersApiAxiosParamCreator(
        configuration,
    ...
    async usersIdBlocking(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<UsersBlockingLookupResponse>
    > {
      const localVarAxiosArgs = await UsersApiAxiosParamCreator(
        configuration,
